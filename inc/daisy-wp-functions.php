 ...
 */
 ...
 function daisy_fonts_url() {
      ...
      $sansPro = _x('on', 'SansPro font: on or off','daisy');
        ...
        if('off' !== $sansPro){
          $font_families[] = 'Source+Sans+Pro:400,300,300i,400i,600,700,900';
        }


     	if ( in_array('on', array($poppins, $quicksand, $raleway, $PTSans, $sansPro)) ) {
